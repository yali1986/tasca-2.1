...
for (let [index, element] of noms.entries())  {      
 ...
 print6.innerHTML += `Índice ${index}: ${element}<br>` 
}       
 
// otra manera de imprimir el indice de cada elemento del array con forEach: 
noms.forEach((valor, index) => console.log(`Índice ${index}: ${valor}`))